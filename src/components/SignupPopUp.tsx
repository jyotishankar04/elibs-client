...
function SignupPopUp() {
  return (
    <div className="w-full h-screen  flex justify-center items-center  bg-gray-600/35 top-0  fixed">
      <div className=" p-4 bg-white rounded-lg flex-col gap-10 w-[80%] h-[80%] flex items-center justify-center">
        ...
        <Link
          to={"/auth/signup"}
          className="text-white bg-orange-600 py-2 px-6 rounded-lg text-2xl"
        >
